  ...
  webview.setWebViewClient(
    new JavaAdapter(WebViewClient, {
      ...
      shouldOverrideUrlLoading: function (view, request) {
        ...
        console.log('override url:', url, 'redirect:', request.isRedirect(), 'isForMainFrame:', request.isForMainFrame(), 'hasGesture:', request.hasGesture(), 'getMethod:' + request.getMethod())
        app.openUrl(url)
        return true
      },
