 ...
 * @Last Modified time: 2022-08-10 19:45:48
...
module.exports = {
  ...
  findBySIFTGrayBase64: function (originImg, base64, alreadyGray) {
    if (alreadyGray) {
      originImg = images.cvtColor(originImg, "GRAY2BGRA")
    } else {
      originImg = images.cvtColor(images.grayscale(originImg), "GRAY2BGRA")
    }
    return this.findBySIFT(originImg, images.fromBase64(base64))
  },
  /**
