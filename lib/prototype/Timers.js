 ...
 * @Last Modified time: 2024-07-23 21:41:05
...
module.exports = (function (_runtime_, scope) {
  ...
  timers.queryTimedTasks = function (options, callback) {
    ...
    return is_pro ? util.java.toJsArray(TimedTaskManager.queryTimedTasks(sql || null, args)) : (() => {
  ...
  timers.queryIntentTasks = function (options, callback) {
    ...
    return util.java.toJsArray(allIntentTasks).filter(intentTask => {
