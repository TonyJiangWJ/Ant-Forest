 ...
 * @Last Modified time: 2022-08-04 15:43:05
 * @Description: 
 */
...
module.exports = {
  ...
  gestureDown: function (startY, endY) {
    return _automator.scrollDown(startY, endY)
  },
  gestureUp: function (startY, endY) {
    return _automator.scrollUp(startY, endY)
  },
...
function CommonAutomation () {
  this.scrollDown = function (startY, endY) {
    ...
    this.gesture(points.length * 8, points)
  }

  this.scrollUp = function (startY, endY) {
    let deviceHeight = _config.device_height || 1900
    let points = []
    let startX = parseInt(_config.device_width / 2)
