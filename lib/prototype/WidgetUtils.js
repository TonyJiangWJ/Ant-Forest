 ...
 * @Last Modified time: 2020-09-22 20:40:30
 * @Description: 
 */
...
const friendHomeWaiting = function () {
  return widgetWaiting(_config.friend_home_ui_content, '好友首页') && widgetWaiting(_config.friend_name_getting_regex || '.*的蚂蚁森林', '好友首页')
}
