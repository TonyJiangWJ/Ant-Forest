...
function CommonFunctions () {
   ...
   * @param {boolean} persistArgs 是否带上执行参数
   */
  this.setUpAutoStart = function (minutes, forceSetup, persistArgs) {
    ...
    let task = Timers.addDisposableTask({
      path: mainScriptJs,
      date: millis,
      executeArguments: persistArgs ? engines.myEngine().execArgv : null
    })
