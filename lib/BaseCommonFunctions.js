...
function CommonFunctions () {
  ...
  */
   ...
   * @returns 
   */
  this.commonDelay = function (minutes, text, removeRunningTask) {
  ...
  this.delayStartIfInPayCode = function () {
    ...
    let paycodeContent = this._widgetUtils.widgetGetOne(_config.delay_start_pay_code_content || '向商家付(钱|款)', 1000, false, true)
    if (paycodeContent && paycodeContent !== (_config.delay_start_pay_code_content || '向商家付(钱|款)')) {
