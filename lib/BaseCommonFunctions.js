...
function CommonFunctions () {
  ...
  */
  ...
  this.delayStartIfInPayCode = function () {
    ...
    let paycodeContent = this._widgetUtils.widgetGetOne(_config.delay_start_pay_code_content || '向商家付(钱|款)', 1000, true, true)
    if (paycodeContent && paycodeContent.content.indexOf(_config.delay_start_pay_code_content || '向商家付(钱|款)') < 0) {
