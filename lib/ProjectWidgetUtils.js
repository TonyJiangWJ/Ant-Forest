...
const ProjectWidgetUtils = function () {
  ...
  this.getCurrentEnergy = function () {
    ...
    let ocrRegion = [_config.device_width * 0.6, _config.device_height * 0.05, _config.device_width * 0.4, _config.device_height * 0.2]
    ...
    if (recognizeResult && recognizeResult.length > 0) {
      ...
      let result = recognizeResult[0].label
      let energy = parseInt(result.match(/\d+/))
