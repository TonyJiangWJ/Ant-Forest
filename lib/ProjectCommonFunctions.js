...
const ProjectCommonFunction = function () {
   ...
   * 定义缓存KEY列表 用于导出运行时数据
   */
  this.keyList = [ENERGY_TAG, RUN_TIMES_TAG, PROTECT_TAG, FRIEND_COLLECT_TAG, BAIDU_INVOKE_COUNT, TESSERAC_INVOKE_COUNT, WATERING_COOPERATION_PLANT, COOL_DOWN, USER_NAME_MD5]
