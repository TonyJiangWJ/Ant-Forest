 ...
 * @Last Modified time: 2019-12-03 21:00:56
 * @Description: 
 */
...
const friendListWaiting = function () {
  return widgetWaiting(_config.friend_list_ui_content, '好友排行榜')
}
...
const wateringFriends = function () {
  let wateringWidget = widgetGetOne(_config.warting_widget_content)
  if (wateringWidget) {
