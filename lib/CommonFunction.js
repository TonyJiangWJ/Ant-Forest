 ...
 * @Last Modified time: 2019-12-04 10:40:13
 * @Description: 通用工具
 */
...
function CommonFunctions () {
  ...
  this.showDialogAndWait = function (checkedSpringboard) {
    ...
    threads.start(function () {
      ...
      let sleepCount = _config.delayStartTime / 1000
  ...
  this.recordFriendCollectInfo = function (friendCollect) {
    ...
    if (
      ...
      // 今日收集大于阈值，且未浇过水
      collectInfo.todayCollect > _config.wateringThresold && collectInfo.todayWatering <= 0
      // 不在浇水黑名单内
