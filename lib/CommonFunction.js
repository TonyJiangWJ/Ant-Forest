 ...
 * @Last Modified time: 2019-11-29 15:38:27
 * @Description: 通用工具
 */
      ...
      if (_this.isEmpty(floatyWindow)) {
        ...
        try {
          ...
          if (_this.isEmpty(floatyWindow)) {
            ...
            _debugInfo('设置悬浮窗位置完毕： textColor:' + floatyWindow.content.textColor)
            initialized = true
          } else {
            initialized = true
          }
        } catch (e) {
          _errorInfo('创建悬浮窗异常' + e)
        } finally {
          floatyLock.unlock()
        }
        sleep(500)
