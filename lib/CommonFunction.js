...
function CommonFunctions() {
  ...
  this.info = function (string, toast) {
    if (toast) {
      toast(string)
    }
    console.info(string)
  ...
  this.warn = function (string, toast) {
    if (toast) {
      toast(string)
    }
    console.warn(string)
  ...
  this.error = function (string, toast) {
    if (toast) {
      toast(string)
    }
  ...
  this.debug = function (string, toast) {
    if (config.show_debug_log) {
      console.verbose(string)
      if (config.toast_debug_info || toast) {
        toast(string)
      }
    }
    this.appedLog(string)
  ...
  this.log = function (string, toast) {
    if (toast) {
      toastLog(string)
    } else {
      log(string)
