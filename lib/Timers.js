 ...
 * @Last Modified time: 2019-12-26 18:55:24
...
module.exports = function (runtime, scope) {
  ...
  let is_modify = getVerName("current_autojs").match(/autojsm/);
...
function _getVerName (name, params) {
  ...
  function _handleName (name) {
    if (name.match(/^[Aa]uto\.?js/)) return "org.autojs.autojs" + (name.match(/[Pp]ro$/) ? "pro" : (name.match(/autojsm/) ? "m" : ""));
