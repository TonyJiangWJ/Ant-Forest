 ...
 * @Last Modified time: 2024-07-23 21:55:57
 * @Description: 
 */
...
let NORMAL_DEVICE = function (obj) {
  ...
  this.unlock = function (password) {
    ...
    let unlockers = [
      ...
      { id: '(colorL|l)ockPatternView', unlock: () => _this.unlock_pattern() },
      {
...
module.exports = {
  exec: function () {
    ...
    let executedByTimeTask = executeArguments.intent
    ...
    if (!_unlocker.relock) {
      ...
      if (executedByTimeTask || executeArguments.executeByDispatcher) {
        let skipped = false
        // 未锁定屏幕情况下，判断是否在白名单中
        do {
